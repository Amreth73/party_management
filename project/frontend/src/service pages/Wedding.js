      ...
      <div className="party-decor-container">
        <main className="dpcontent-section">
          ...
          <p>
            ...
            team manages everything from theme selection and venue decoration to
            entertainment and catering, ensuring a seamless and elegant
            celebration.
          </p>
          ...
          <div className="dpsection">
            ...
            <div className="image-gallery">
              <img
                src="https://prestigiousvenues.com/wp-content/uploads/2021/12/Best-beach-event-destination-Lujo-Hotel-Bodrum-Prestigious-Venues-2.jpg"
                alt="Event Venue 1"
              />
          ...
          <div className="dpsection">
            ...
            <div className="image-gallery">
              <img
                src="https://prestigiousvenues.com/wp-content/uploads/2021/04/Bar-Venue-The-St.-Regis-Shanghai-Jingan-Prestigious-Venues.jpg"
                alt="Event Venue 4"
              />
              <div className="image-row">
                <img
                  src="https://prestigiousvenues.com/wp-content/uploads/2021/04/Gala-Dinner-Venue-The-St.-Regis-Shanghai-Jingan-Prestigious-Venues.jpg"
                  alt="Event Venue 5"
                />
                <img
                  src="https://prestigiousvenues.com/wp-content/uploads/2022/05/Vistas-Restaurant-Hire-at-Monte-Rei-Prestigious-Venues-3000px.jpg"
                  alt="Event Venue 6"
                />
              </div>
              <div className="image-row">
                <img
                  src="https://prestigiousvenues.com/wp-content/uploads/2022/05/Exclusive-buyout-of-Monte-Rei-Prestigious-Venues.jpg"
                  alt="Event Venue 7"
                />
                <img
                  src="https://prestigiousvenues.com/wp-content/uploads/2022/05/Events-in-linked-villas-exterior-terrace-Club-House-Residences-Monte-Rei-Prestigious-Venues.jpg"
                  alt="Event Venue 8"
                />
              </div>
            </div>
          ...
          <div className="dpsection">
            ...
            <div className="image-gallery">
              <img
                src="https://prestigiousvenues.com/wp-content/uploads/2017/03/Bali-Wedding-Venue-InterContinental-Bali-Resort-Prestigious-Venues.jpg"
                alt="Event Venue 9"
              />
            </div>
          </div>
